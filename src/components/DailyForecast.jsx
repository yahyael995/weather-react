      ...
      {data.time.map((time, index) => {
        ...
        return (
          <div key={index} className="day-item">
            ...
            <img src={getWeatherIcon(iconCode)} alt="Weather icon" className="weather-icon" />
            <div className="temp-range">
              <span>{maxTemp}{tempUnitLabel}</span>
              <span className="temp-min">{minTemp}{tempUnitLabel}</span>
            </div>
          </div>
        );
      })}
