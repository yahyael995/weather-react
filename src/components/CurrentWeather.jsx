// src/components/CurrentWeather.jsx (النسخة النهائية مع الإصلاح النهائي)
...
const CurrentWeather = ({ data, unit }) => {
  ...
  const weatherCode = data.current.weathercode; // Correctly defined here
  ...
  return (
    <div className="solid-card current-weather">
      ...
      <div className="description">
        {/* --- هذا هو الإصلاح: نستخدم المتغير الصحيح --- */}
